...
export const boards: Board[] = [
  ...
  { id: "board-overseas", slug: "overseas", name: "해외분야", group: "general", description: "해외 취업, 이민, 자격, 영어 준비 정보를 나눕니다." },
  { id: "board-graduate-research", slug: "graduate-research", name: "대학원/연구원", group: "general", description: "대학원 진학, 연구원 커리어, 논문과 연구실 정보를 공유합니다." },
  { id: "board-crc-cra-cro", slug: "crc-cra-cro", name: "CRC/CRA/CRO", group: "general", description: "임상시험 코디네이터, CRA, CRO 커리어 정보를 나눕니다." },
  { id: "board-pathology", slug: "pathology", name: "병리과", group: "general", description: "조직병리, 세포병리, 병리과 업무와 커리어 정보를 공유합니다." },
