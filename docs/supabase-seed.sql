...
values
  ...
  (uuid_generate_v5(uuid_ns_url(), 'k-lab-portal/board/overseas'), 'overseas', '해외분야', 'general', '해외 취업, 이민, 자격, 영어 준비 정보를 나눕니다.', false),
  (uuid_generate_v5(uuid_ns_url(), 'k-lab-portal/board/graduate-research'), 'graduate-research', '대학원/연구원', 'general', '대학원 진학, 연구원 커리어, 논문과 연구실 정보를 공유합니다.', false),
  (uuid_generate_v5(uuid_ns_url(), 'k-lab-portal/board/crc-cra-cro'), 'crc-cra-cro', 'CRC/CRA/CRO', 'general', '임상시험 코디네이터, CRA, CRO 커리어 정보를 나눕니다.', false),
  (uuid_generate_v5(uuid_ns_url(), 'k-lab-portal/board/pathology'), 'pathology', '병리과', 'general', '조직병리, 세포병리, 병리과 업무와 커리어 정보를 공유합니다.', false),
