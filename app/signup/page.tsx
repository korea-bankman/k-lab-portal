    ...
    <div className="container-page flex min-h-[70vh] items-center justify-center py-8">
      <div className="w-full max-w-md rounded-lg border bg-white p-6 shadow-soft">
        ...
        <form action={signupAction} className="mt-6 space-y-4">
          ...
          <input name="nickname" className="w-full rounded-md border px-4 py-3" placeholder="닉네임" required />
          <select name="department" className="w-full rounded-md border px-4 py-3" defaultValue="">
          ...
          <input name="password" className="w-full rounded-md border px-4 py-3" type="password" placeholder="비밀번호" minLength={6} required />
